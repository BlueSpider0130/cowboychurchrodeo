...
<div class="container-fluid py-4">
    ...
    <div class="mb-4">
        ...
        <div class="text-md-right">
            <a href="{{ route('L2.contestants.create', [$organization]) }}" class="btn btn-primary btn-sm">
            ...
            @foreach( $contestants as $contestant )
                <tr>
                    ...
                    <td class="text-md-center">
                        <a href="{{ route('L2.contestants.show', [$organization, $contestant]) }}" class="btn btn-outline-primary btn-sm">
                            Details 
                        </a>
                    </td>

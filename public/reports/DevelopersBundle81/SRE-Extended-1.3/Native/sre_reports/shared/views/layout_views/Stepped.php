...
//$row = mysql_fetch_array($link,MYSQL_ASSOC);
               ...
               $row = arr_to_lower($row);
                ...
                if ($index != -1) {
                    ...
                    if (!empty($group_by)) {
                        ...
                        for ($i = $index; $i < $levels; $i++) {
                            ...
                            if ($i == 0 && $index == 0) {
                                ...
                                echo "<tr class='mainpage stepped' ><td align='center' class='TableCell' >" . render($row[get_field_part($group_by[0],$row)], array_change_key_case($cells,CASE_LOWER)[strtolower($group_by[0])], $group_by[0])  . "</td><td $span;></td> </tr>";
                            } else {
                    ...
                    //echo"<tr><td><table width='100%'  array_change_key_case($cells,CASE_LOWER)pacing='0' cellpadding='10'>";

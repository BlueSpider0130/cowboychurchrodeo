...
<script type="text/javascript" src="../shared/Js/jquery.ui.core.min.js"></script>
<script type="text/javascript" src="../shared/Js/jquery.ui.datepicker.min.js"></script>
<script type="text/javascript" src="../shared/Js/jquery-ui-timepicker-addon.js"></script>
...
<script language="JavaScript" type="text/javascript">
    var dataStr = new Array("text");
    var dataInt = new Array("number");
    var dataDate = new Array("date","time",'datetime');
 ...
 var def_value = '<?php echo get_default_value('keyWord') ?>';
        ...
        // var show_advanced = <?php if (!empty($btnSearch)) echo 'true';
                            else echo 'false'; ?>;
        ...
        $("#SearchField").change(function() {
            ...
            else if (dataDate.indexOf(dataty) > -1)
            {
                ...
                $('#search_feild_div').append('<input class="search-txtbox" style="width:123px;" placeholder="<?php echo escape($from_lang); ?>"  name="keyWord" value="' + val + '" type="text" typ="' + dataty + '" id="keyWord" /><input style="width:123px;" placeholder="<?php echo escape($To_lang);?>"  name="keyWord2" value="' + val2 + '" type="text" typ="' + dataty + '" id="keyWord2" class="search-txtbox" />');
                $(':text').blur();
                if (dataty == 'time')
                {

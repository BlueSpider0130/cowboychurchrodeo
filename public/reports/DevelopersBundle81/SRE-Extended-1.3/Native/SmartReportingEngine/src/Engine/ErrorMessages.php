...
class ErrorMessages {
    ...
    public static $messages = array(
        "en" => array(
            ...
            "22" => "The 'SRE__Engin__DIR__' constant can't be empty in '/sre_config/config.php' file.",
            "23" => "The 'SRE__CORE__DIR__ ' constant can't be empty in '/sre_config/config.php' file.",
